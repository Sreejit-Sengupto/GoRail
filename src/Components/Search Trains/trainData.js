export const trainData = [
  ...
  {
    train_number: "11057",
    train_name: "MUMBAI CSMT - AMRITSAR Pathankot Express",
    run_days: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
    train_src: "CSMT",
    train_dstn: "ASR",
    from_std: "00:05",
  ...
  {
    train_number: "12925",
    train_name: "MUMBAI CENTRAL - AMRITSAR Paschim SF Express",
    run_days: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
    train_src: "MMCT",
    train_dstn: "ASR",
    from_std: "11:58",
  ...
  {
    train_number: "12137",
    train_name: "MUMBAI CSMT - FIROZPUR CANTT Punjab Mail SF Exp",
    run_days: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
    train_src: "CSMT",
    train_dstn: "FZR",
    from_std: "19:50",
